...
#' @param fields Fields to return, string separated by comma. Leave as NULL to get the default set marked in the API spec
#'
...
results2025_1 <- search_nsf_award_api(expDateStart="01/01/2025",expDateEnd="06/30/2025", maxResults = 10000)
results2025_2 <- search_nsf_award_api(expDateStart="07/01/2025",expDateEnd="12/31/2025", maxResults = 10000)
results2026_1 <- search_nsf_award_api(expDateStart="01/01/2026",expDateEnd="06/30/2026", maxResults = 10000)
results2026_2 <- search_nsf_award_api(expDateStart="07/01/2026",expDateEnd="08/31/2026", maxResults = 10000)
results2026_3 <- search_nsf_award_api(expDateStart="09/01/2026",expDateEnd="12/31/2026", maxResults = 10000)
results2027_1 <- search_nsf_award_api(expDateStart="01/01/2027",expDateEnd="06/30/2027", maxResults = 10000)
results2027_2 <- search_nsf_award_api(expDateStart="07/01/2027",expDateEnd="12/31/2027", maxResults = 10000)
results2028 <- search_nsf_award_api(expDateStart="01/01/2028",expDateEnd="12/31/2028", maxResults = 10000)
results2029 <- search_nsf_award_api(expDateStart="01/01/2029",expDateEnd="12/31/2029", maxResults = 10000)
results2030 <- search_nsf_award_api(expDateStart="01/01/2030", maxResults = 10000)
